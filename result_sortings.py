...
print(f"Отсортированный список быстрой сортировкой 1: {quick_sort_1(nums_3, 0, len(nums_3) - 1)}")
print(f"Отсортированный список быстрой сортировкой 2: {quick_sort_2(nums_3)}")
